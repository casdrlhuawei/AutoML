...
parser.add_argument('--layers', type=int, default=6, help='total number of conv layers')
...
parser.add_argument('--save', type=str, default='./final_imagenet', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='B_PCDARTS_image', help='which architecture to use')
