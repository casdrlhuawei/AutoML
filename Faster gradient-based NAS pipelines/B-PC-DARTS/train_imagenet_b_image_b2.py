...
parser.add_argument('--save', type=str, default='./final_PCDARTS_image_b2_new_v2', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='PCDARTS_b_image_v2', help='')
...
parser.add_argument('--resume', default='./final_PCDARTS_image_b2_new_v2', type=str, help='path to latest checkpoint (default: none)')
...
args.save = '/home1/dzx/gradient-based-BNAS-outputs/' + args.save
